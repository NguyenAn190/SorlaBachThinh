...
@Entity
@Table(name = "cart_item", schema = "solarbachthinhdb", catalog = "")
public class CartItem {
    ...
    @Basic
    @Column(name = "invoice_cart_item_id", nullable = false)
    private int invoiceCartItemId;
    ...
    private Collection<Orders> ordersByCartId;
    ...
    public int getInvoiceCartItemId() {
        return invoiceCartItemId;
    }

    public void setInvoiceCartItemId(int invoiceCartItemId) {
        this.invoiceCartItemId = invoiceCartItemId;
    }
    ...
    public Collection<Orders> getOrdersByCartId() {
        return ordersByCartId;
    }

    public void setOrdersByCartId(Collection<Orders> ordersByCartId) {
        this.ordersByCartId = ordersByCartId;
    }
}
